...
public class JLog {
    ...
    public static void printStackTrace() {
        ...
        JLog.e(mGlobalTag, "║   " + "current thread name : " + Thread.currentThread().getName());
        //ignore top 3 traces.
    ...
    public static void printHashMapObj(Object map) {
        ...
        JLog.e(mGlobalTag, "║ " + "total element number : " + objList.length);
        for(String obj:objList) {
            String[] kv = obj.split("=");
            JLog.e(mGlobalTag,"║ " + "key = " + kv[0].trim() + ", value = " + kv[1].trim());
        }
    ...
    public static void printArrayListObj(Object list) {
        ...
        JLog.e(mGlobalTag, "║ " + "total element number : " + objs.size());
        for(int i=0; i<objs.size();i++) {
            String str = objs.get(i).toString();
            JLog.e(mGlobalTag,"║ " + "item = " + str);
        }
...
//        String tag = (tagStr == null ? className : tagStr);
    ...
    private static void printStackTraceLine(String tag, boolean isTop) {
        if (isTop) {
            JLog.e(tag, "╔════════════════════════════════ Stack Trace Begin ══════════════════════════════════");
        } else {
            JLog.e(tag, "╚════════════════════════════════ Stack Trace End ════════════════════════════════════");
        }
    }

    private static void printHashMapLine(String tag, boolean isTop) {
        if (isTop) {
            JLog.e(tag, "╔════════════════════════════════ HashMap object Begin ══════════════════════════════════");
        } else {
            JLog.e(tag, "╚════════════════════════════════ HashMap object End ════════════════════════════════════");
        }
    }

    private static void printArrayListLine(String tag, boolean isTop) {
        if (isTop) {
            JLog.e(tag, "╔════════════════════════════════ ArrayList object Begin ══════════════════════════════════");
        } else {
            JLog.e(tag, "╚════════════════════════════════ ArrayList object End ════════════════════════════════════");
        }
    }
